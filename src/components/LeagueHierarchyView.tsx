    ...
    >
      ...
      <div className="grid grid-cols-3 gap-2 mb-3 text-xs">
        <div className="bg-gray-900/50 rounded px-2 py-1">
          <span className="text-gray-500 block">Tim</span>
        ...
        {league.promotion_slots > 0 && (
          <div className="bg-green-900/20 rounded px-2 py-1">
            <span className="text-gray-500 block">⬆️ Promosi</span>
        ...
        {league.relegation_slots > 0 && (
          <div className="bg-red-900/20 rounded px-2 py-1">
            <span className="text-gray-500 block">⬇️ Degradasi</span>
        ...
        {league.playoff_slots > 0 && (
          <div className="bg-blue-900/20 rounded px-2 py-1">
            <span className="text-gray-500 block">🏆 Playoff</span>
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Sistem liga dengan promosi & degradasi</p>
            </div>
          </div>
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Liga esports dengan sistem tier</p>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Kompetisi piala knockout</p>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-lg p-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
          <div className="flex items-center gap-2">
            <span className="text-green-400">⬆️</span>
            <span className="text-gray-400">Promosi ke liga atas</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-red-400">⬇️</span>
            <span className="text-gray-400">Degradasi ke liga bawah</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-blue-400">🏆</span>
            <span className="text-gray-400">Playoff promosi/degradasi</span>
          </div>
          <div className="flex items-center gap-2">
            <span>⚽/🎮</span>
            <span className="text-gray-400">Football / eFootball</span>
          </div>
        </div>
      </div>
    </div>
